<audio id="index_music" src="<?php echo $GLOBALS['url_path'];?>assets/sound/index_music.mp3" allow="autoplay" loop ></audio>
<script>
...
<audio id="game_music" src="<?php echo $GLOBALS['url_path'];?>assets/sound/game_music.mp3" allow="autoplay" loop ></audio>
<script>
...
<audio id="sound_achievement" src="<?php echo $GLOBALS['url_path'];?>assets/sound/achievement.mp3" allow="autoplay"></audio>
<script>
...
<audio id="on_error" src="<?php echo $GLOBALS['url_path'];?>assets/sound/error.mp3" allow="autoplay"></audio>
<script>
...
<audio id="on_click" src="<?php echo $GLOBALS['url_path'];?>assets/sound/close_window.mp3" allow="autoplay"></audio>
<script>
...
<audio id="on_hover" src="<?php echo $GLOBALS['url_path'];?>assets/sound/on_click.mp3" allow="autoplay" ></audio>
<script>
...
<audio id="open_window" src="<?php echo $GLOBALS['url_path'];?>assets/sound/open_window.mp3" allow="autoplay"></audio>
<script>
...
<audio id="keyboard" src="<?php echo $GLOBALS['url_path'];?>assets/sound/on_hover.wav" allow="autoplay"></audio>
<script>
